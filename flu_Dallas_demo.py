...
# Obtain path to folder with JSON input files
#base_path = Path("/Users/dk29776/Dropbox/UTAustin/City-Level-Transmission/CLT_BaseModel/flu_demo_input_files")
# Get filepaths for initial values of state variables, fixed parameters,
#   and configuration
north_compartments_epi_metrics_init_vals_filepath = base_path / "Dallas_north_compartments_epi_metrics_init_vals.json"
north_params_filepath = base_path / "Dallas_north_common_params.json"
north_config_filepath = base_path / "config.json"

north_compartments_epi_metrics_dict = clt.load_json_new_dict(north_compartments_epi_metrics_init_vals_filepath)
north_params_dict = clt.load_json_new_dict(north_params_filepath)
north_config_dict = clt.load_json_new_dict(north_config_filepath)

north_config_dict["transition_type"] = "binomial_deterministic"


south_compartments_epi_metrics_init_vals_filepath = base_path / "Dallas_south_compartments_epi_metrics_init_vals.json"
south_params_filepath = base_path / "Dallas_south_common_params.json"
south_config_filepath = base_path / "config.json"

south_compartments_epi_metrics_dict = clt.load_json_new_dict(south_compartments_epi_metrics_init_vals_filepath)
south_params_dict = clt.load_json_new_dict(south_params_filepath)
south_config_dict = clt.load_json_new_dict(south_config_filepath)

south_config_dict["transition_type"] = "binomial_deterministic"
...
south_compartments_epi_metrics_dict = \
    clt.load_json_new_dict(south_compartments_epi_metrics_init_vals_filepath)
south_params_dict = clt.load_json_new_dict(south_params_filepath)
south_config_dict = clt.load_json_new_dict(south_config_filepath)


north_compartments_epi_metrics_dict = \
    clt.load_json_new_dict(north_compartments_epi_metrics_init_vals_filepath)
north_params_dict = clt.load_json_new_dict(north_params_filepath)
north_config_dict = clt.load_json_new_dict(north_config_filepath)
...
north = flu.FluSubpopModel(north_compartments_epi_metrics_dict,
                           north_params_dict,
                           north_config_dict,
                           calendar_df,
...
south = flu.FluSubpopModel(south_compartments_epi_metrics_dict,
                           south_params_dict,
                           south_config_dict,
                           calendar_df,
