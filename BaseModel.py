...
class BaseModel:
    ...
    def __init__(self, epi_params, simulation_params, RNG_seed=50505050):
        ...
        self.list_of_compartment_objects = []
        ...
        for name, compartment in self.name_to_compartment_dict.items():
            ...
            self.list_of_compartment_objects.append(compartment)
    ...
    def create_compartment_attribute_dict(self, key_string, value_string):
        d = {}
        for object in self.list_of_compartment_objects:
