...
def test_metapop_no_travel(subpop_model: flu.FluSubpopModel):
    ...
    metapopAB_model.subpop_models.subpopA.params.prop_time_away = np.zeros((num_age_groups, num_risk_groups))

    subpopA_independent.params.prop_time_away = np.zeros((num_age_groups, num_risk_groups))
    subpopB_independent.params.prop_time_away = np.zeros((num_age_groups, num_risk_groups))
